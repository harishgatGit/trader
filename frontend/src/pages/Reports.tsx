...
const Reports: React.FC = () => {
  useSEO({
    title: 'Research Reports | Investing Atti',
    description: 'Review and search historically compiled analyst reports generated by Investing Atti AI.',
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            maxLength={10}
            aria-label="Filter reports by stock symbol"
          />
        </div>
        <div className="relative max-w-xs w-full sm:w-auto">
          ...
          <select
            ...
            aria-label="Filter reports by AI rating"
          >
