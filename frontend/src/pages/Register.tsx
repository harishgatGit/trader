...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-200">
      {/* Decorative Glow */}
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-brand-500/10 border border-brand-500/30 text-brand-500 dark:text-brand-400 mb-4 shadow-lg shadow-brand-500/5">
        ...
        <div className="card p-8 border border-slate-800 shadow-2xl relative overflow-hidden">
          {success ? (
            <div className="py-6 text-center space-y-4 animate-fade-in">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-450 border border-emerald-500/20">
            ...
            <>
              {errorMsg && (
                <div className="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-600 dark:text-red-400 text-sm flex gap-3 items-start animate-fade-in">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  <button
                    type="submit"
                    disabled={authLoading}
                    className="w-full btn btn-primary py-3 flex items-center justify-center gap-2 font-bold text-sm tracking-wide shadow-md shadow-brand-500/10"
                  >
                    {authLoading ? (
                      <>
